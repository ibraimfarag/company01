                ...
                <div class="col-md-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <br/>
                            <br/>
                            <form action="{{ url('admin/our-team/update') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="is_hidden" class="form-control">
                                                <option value="1" {{ $data->is_hidden ? 'selected' : '' }}>Yes</option>
                                                <option value="0" {{ !$data->is_hidden ? 'selected' : '' }}>No</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="order" class="form-control">
                                                @for($x=1;$x<100;$x++)
                                                    <option {{$data->order==$x ? 'selected' : ''}} value="{{$x}}">{{$x}}</option>
                                                @endfor
                                            </select>
                                        </div>
                                    </div>
